...
export const fetchMarketPlaceDataStart = ()=>createActions('FETCH_MARKETPLACE_START')

export const fetchMarketPlaceDataSuccess = (marketPlaceData)=>createActions('FETCH_MARKETPLACE_SUCCESS',marketPlaceData)

export const fetchMarketPlaceDataFailure = (errorMessage)=>createActions('FETCH_MARKETPLACE_FAILURE',errorMessage)
...
export const fetchMarketPlaceAsyncData = ()=>{
    ...
    return async (dispatch)=>{
        ...
        try{
      const response = await fetch('https://api.everywatch.com/api/Analysis/GetAnalysisDumy',{
            headers:{
